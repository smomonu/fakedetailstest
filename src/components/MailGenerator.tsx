    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-blue-600 via-purple-600 to-purple-700 py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">Mail Generator</h1>
      ...
      <section id="how-it-works" className="py-12 md:py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-base md:text-xl text-gray-600 max-w-3xl mx-auto">Generate large batches of realistic email addresses: pick domain and style, adjust options, generate, then export.</p>
          </div>
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8 items-start">
            <div className="text-center">
              ...
              <Mail className="w-6 h-6 text-purple-600 mx-auto mb-4" />
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Choose Domain & Style</h3>
              <p className="text-gray-600 leading-relaxed">Select domain and local-part style (firstlast, first.last, initials, random) to guide output.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed">Set max local-part length, include numbers, and adjust batch size for unique datasets.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed">Produce deduplicated lists for testing, mockups, or demos.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed">Download .txt lists or copy addresses for fixtures and import into systems.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="py-12 md:py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-base md:text-xl text-gray-600 max-w-3xl mx-auto">Bulk generation, multiple styles, one-click copy, and export-ready outputs tailored for QA and mockups.</p>
          </div>
      ...
      <section id="why-choose-us" className="py-12 md:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-base md:text-xl text-gray-600 max-w-3xl mx-auto">Fast, private, and export-ready email generation for realistic datasets without external services.</p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-sm hover:shadow-xl border border-gray-100">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 mb-4">Realistic Patterns</h3>
              <p className="text-gray-600 leading-relaxed">Craft emails that look natural for testing UIs and pipelines.</p>
            </div>
            <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-sm hover:shadow-xl border border-gray-100">
              <div className="w-16 h-16 bg-indigo-500 rounded-xl flex items-center justify-center mb-6">
                <Briefcase className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-2xl font-semibold text-gray-900 mb-4">Integrations Friendly</h3>
              <p className="text-gray-600 leading-relaxed">Export .txt lists ready for import into test suites, fixtures, and demo environments.</p>
            </div>
            <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-sm hover:shadow-xl border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">Multiple local-part formats help you match production-like datasets quickly.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl mb-6">
              <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
            </div>
            ...
            {faqs.map((faq, index) => (
              <div key={index} className="group">
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl border border-white/50 overflow-hidden transition-all duration-300 hover:transform hover:scale-[1.02]">
                  <button onClick={() => setOpenFaq(openFaq === index ? null : index)} className="w-full p-6 md:p-8 text-left flex items-center justify-between hover:bg-gradient-to-r hover:from-purple-50/50 hover:to-blue-50/50 transition-all duration-300">
                    <div className="flex items-center space-x-4">
                      <div className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-300 ${openFaq === index ? 'bg-gradient-to-r from-purple-600 to-blue-600 text-white shadow-lg' : 'bg-gray-100 text-gray-600 group-hover:bg-purple-100 group-hover:text-purple-600'}`}><span className="font-bold text-sm">{index + 1}</span></div>
                    ...
                    <div className={`w-12 h-12 rounded-xl flex items-center justify-center transition-all duration-300 ${openFaq === index ? 'bg-gradient-to-r from-purple-600 to-blue-600 text-white rotate-180' : 'bg-gray-100 text-gray-500 group-hover:bg-purple-100 group-hover:text-purple-600'}`}><ChevronDown className="w-5 h-5 transition-transform duration-300" /></div>
                  </button>
                  <div className={`overflow-hidden transition-all duration-500 ease-in-out ${openFaq === index ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}><div className="px-6 md:px-8 pb-6 md:pb-8"><div className="ml-14 bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl p-6 border-l-4 border-gradient-to-b border-purple-500"><p className="text-gray-700 leading-relaxed text-lg">{faq.answer}</p></div></div></div>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-purple-600 to-blue-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-white mb-6">Create realistic email datasets — fast</h2>
          <p className="text-xl text-purple-100 mb-8 max-w-2xl mx-auto">Generate, export, and integrate email lists for testing, mockups, and demos — all locally in your browser.</p>
