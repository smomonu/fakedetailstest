...
const PhoneNumberGenerator: React.FC = () => {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section id="how-it-works" className="py-12 md:py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-base md:text-xl text-gray-600 max-w-3xl mx-auto">Follow these steps to generate phone numbers suitable for testing and mock data.</p>
          </div>
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8 items-start">
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed">Choose the target country to match numbering formats and dialing codes.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed">Pick national, E.164, or custom formatting and toggle separators.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed">Specify batch size and generate unique numbers for tests, demos, or seeding.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed">Copy single numbers or download lists for import into tools and test environments.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="why-choose-us" className="py-12 md:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-base md:text-xl text-gray-600 max-w-3xl mx-auto">Accurate formats, local generation, and easy exports for QA and design teams.</p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-sm hover:shadow-xl border border-gray-100">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 mb-4">Format Accuracy</h3>
              <p className="text-gray-600 leading-relaxed">Outputs respect local dialing patterns and common formatting standards.</p>
            </div>
            <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-sm hover:shadow-xl border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">All generation runs locally in the browser — nothing is transmitted to servers.</p>
            </div>
            <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-sm hover:shadow-xl border border-gray-100">
              <div className="w-16 h-16 bg-purple-500 rounded-xl flex items-center justify-center mb-6">
                <Download className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-2xl font-semibold text-gray-900 mb-4">Easy Export</h3>
              <p className="text-gray-600 leading-relaxed">Download lists or copy numbers instantly for use in tests, fixtures, and documentation.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gradient-to-r from-purple-600 to-blue-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-white mb-6">Generate phone numbers quickly</h2>
          <p className="text-xl text-purple-100 mb-8 max-w-2xl mx-auto">Seed tests and demos with realistic phone numbers in seconds — export or copy as needed.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button onClick={() => document.getElementById('generator')?.scrollIntoView({ behavior: 'smooth' })} className="bg-white text-purple-600 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-gray-50 transition-colors">Start Generating Now</button>
