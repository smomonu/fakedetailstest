...
interface GeneratedDwarfName {
  id: string;
  name: string;
  category: string;
}

const DwarfNameGenerator: React.FC = () => {
  const [generatedNames, setGeneratedNames] = useState<GeneratedDwarfName[]>([]);
  ...
  const categories = [
    { id: 'traditional', name: 'Traditional', icon: Mountain },
    { id: 'warrior', name: 'Warrior', icon: Shield },
    { id: 'craftsman', name: 'Craftsman', icon: Settings },
    { id: 'noble', name: 'Noble', icon: Star },
    { id: 'miner', name: 'Miner', icon: Building2 },
    { id: 'fantasy', name: 'Fantasy', icon: Sparkles },
  ];

  const nameComponents = {
    traditional: {
      prefixes: ['Balin', 'Dain', 'Thorin', 'Gloin', 'Oin', 'Dwalin', 'Nain', 'Fain', 'Kain', 'Lain', 'Main', 'Vain', 'Wain', 'Tain', 'Rain', 'Sain', 'Hain', 'Gain', 'Jain', 'Bain'],
      suffixes: ['son', 'beard', 'hammer', 'axe', 'stone', 'iron', 'gold', 'silver', 'forge', 'mine', 'pick', 'shield', 'helm', 'boot', 'fist', 'arm', 'leg', 'eye', 'nose', 'tooth']
    },
    warrior: {
      prefixes: ['Grimm', 'Thror', 'Azog', 'Bolg', 'Dain', 'Nain', 'Thorek', 'Kazad', 'Khaz', 'Durin', 'Fundin', 'Groin', 'Borin', 'Floi', 'Loni', 'Ori', 'Nori', 'Dori', 'Bifur', 'Bofur'],
      suffixes: ['slayer', 'crusher', 'breaker', 'bane', 'killer', 'destroyer', 'warrior', 'fighter', 'champion', 'hero', 'defender', 'guardian', 'protector', 'avenger', 'striker', 'smasher', 'cleaver', 'render', 'splitter', 'hewer']
    },
    craftsman: {
      prefixes: ['Telchar', 'Gamil', 'Zirak', 'Azaghâl', 'Mîm', 'Ibun', 'Khîm', 'Andvari', 'Regin', 'Fafnir', 'Alvis', 'Dvalin', 'Duneyr', 'Durathror', 'Eitri', 'Brokkr', 'Sindri', 'Loki', 'Wayland', 'Volund'],
      suffixes: ['smith', 'wright', 'maker', 'crafter', 'forger', 'builder', 'shaper', 'molder', 'carver', 'sculptor', 'artisan', 'master', 'expert', 'skilled', 'gifted', 'talented', 'able', 'clever', 'wise', 'learned']
    },
    noble: {
      prefixes: ['Durin', 'Thrain', 'Thror', 'Thorin', 'Dain', 'Nain', 'Balin', 'Gloin', 'Gimli', 'Legolas', 'Aragorn', 'Boromir', 'Faramir', 'Denethor', 'Elrond', 'Gil-galad', 'Thranduil', 'Celeborn', 'Galadriel', 'Arwen'],
      suffixes: ['king', 'lord', 'prince', 'duke', 'earl', 'baron', 'knight', 'noble', 'royal', 'majestic', 'regal', 'sovereign', 'ruler', 'monarch', 'emperor', 'kaiser', 'tsar', 'shah', 'sultan', 'caliph']
    },
    miner: {
      prefixes: ['Dig', 'Drill', 'Pick', 'Shovel', 'Tunnel', 'Shaft', 'Pit', 'Quarry', 'Mine', 'Cave', 'Deep', 'Dark', 'Under', 'Below', 'Down', 'Low', 'Bottom', 'Depth', 'Abyss', 'Chasm'],
      suffixes: ['digger', 'driller', 'picker', 'shoveler', 'tunneler', 'shafter', 'pitter', 'quarrier', 'miner', 'caver', 'delver', 'seeker', 'finder', 'hunter', 'gatherer', 'collector', 'harvester', 'extractor', 'retriever', 'obtainer']
    },
    fantasy: {
      prefixes: ['Mythrax', 'Zephyr', 'Astral', 'Cosmic', 'Mystic', 'Ethereal', 'Celestial', 'Divine', 'Sacred', 'Holy', 'Blessed', 'Hallowed', 'Sanctified', 'Consecrated', 'Venerated', 'Revered', 'Honored', 'Esteemed', 'Respected', 'Admired'],
      suffixes: ['weaver', 'binder', 'caller', 'singer', 'chanter', 'speaker', 'whisperer', 'murmurer', 'utterer', 'invoker', 'summoner', 'conjurer', 'enchanter', 'sorcerer', 'wizard', 'mage', 'magician', 'warlock', 'witch', 'shaman']
    }
  };
  ...
  const features = [
    {
      ...
      description: 'Generate any number of unique dwarf names at once - perfect for fantasy stories, games, and world-building.'
    },
    {
      icon: Settings,
      title: 'Multiple Categories',
      description: 'Choose from 6 categories including traditional, warrior, craftsman, noble, miner, and fantasy themes.'
    },
    {
      icon: Copy,
      title: 'One-Click Copy',
      description: 'Instantly copy any generated dwarf name to your clipboard with a single click for immediate use.'
    },
    {
      icon: Download,
      title: 'Export & Save',
      description: 'Download your generated names as a text file or copy multiple names at once for future reference.'
    },
    {
      icon: Shield,
      title: 'Privacy-First',
      description: 'All name generation happens locally in your browser. We never store or transmit your data.'
    },
    {
      icon: Mountain,
      title: 'Authentic Style',
      description: 'Names follow traditional fantasy dwarf naming conventions with appropriate cultural themes.'
    }
  ];
  ...
  const useCases = [
    {
      ...
      description: 'Create authentic dwarf names for fantasy novels, short stories, and creative writing projects.',
      color: 'bg-purple-500'
    },
    {
      icon: Gamepad2,
      title: 'Gaming & RPGs',
      description: 'Generate names for dwarf characters in tabletop RPGs, video games, and online role-playing.',
      color: 'bg-blue-500'
    },
    {
      icon: Building2,
      title: 'World Building',
      description: 'Perfect for creating dwarf clans, kingdoms, and societies in fantasy worlds and campaigns.',
      color: 'bg-green-500'
    }
  ];
  ...
  const faqs = [
    {
      question: 'Are these names suitable for fantasy settings?',
      answer: 'Yes! Our dwarf names are designed to fit traditional fantasy settings, drawing inspiration from Norse mythology and popular fantasy literature.'
    },
    {
      question: 'Can I use these names in my published work?',
      answer: 'Absolutely! These generated names are perfect for commercial use in books, games, movies, and other creative projects. No attribution required.'
    },
    {
      question: 'What makes each category different?',
      answer: 'Each category uses different naming patterns: Traditional follows classic dwarf conventions, Warrior focuses on battle-themed names, Craftsman emphasizes skills, etc.'
    },
    {
      question: 'How many names can I generate at once?',
      answer: 'There\'s no limit! You can generate any number of dwarf names - from 1 to thousands if needed for large world-building projects.'
    },
    {
      question: 'Is my data stored anywhere?',
      answer: 'No. All name generation happens locally in your browser. We do not store, transmit, or track any generated names or personal data.'
    }
  ];
  ...
  const generateNames = () => {
    ...
    const newNames: GeneratedDwarfName[] = [];
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-lg text-white/80 max-w-2xl mx-auto leading-relaxed">
              Generate unlimited authentic dwarf names for fantasy stories, games, and world-building. Choose from traditional, warrior, craftsman, and other themed categories.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-4 sm:p-6 h-auto lg:h-[600px] flex flex-col">
                <h3 className="text-xl font-semibold text-gray-900 mb-6">Generated Dwarf Names</h3>
                
                <div className="flex-1 flex flex-col lg:min-h-0">
                  {generatedNames.length === 0 ? (
                    <div className="text-center py-8 lg:py-12 flex-1 flex flex-col justify-center">
                      <Mountain className="w-12 h-12 lg:w-16 lg:h-16 mx-auto mb-4 text-gray-400" />
                      <p className="text-base lg:text-lg text-gray-500">No dwarf names generated yet</p>
      ...
      <section id="how-it-works" className="py-12 md:py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-base md:text-xl text-gray-600 max-w-3xl mx-auto">Create authentic dwarf names in four quick steps: pick a category, tune options, generate, and export.</p>
          </div>
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8 items-start">
            <div className="text-center">
              ...
              <Mountain className="w-6 h-6 text-purple-600 mx-auto mb-4" />
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Pick a Category</h3>
              <p className="text-gray-600 leading-relaxed">Choose Traditional, Warrior, Craftsman, Noble, Miner, or Fantasy to influence name components.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed">Adjust length, toggle numbers/symbols, and set batch size to match your workflow.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed">Produce single names or bulk rosters for stories, NPCs, and campaigns.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed">Download .txt lists or copy names for wikis, design docs, and game assets.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="py-12 md:py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-base md:text-xl text-gray-600 max-w-3xl mx-auto">Unlimited generation, category-aware patterns, one-click copy, and export-ready lists.</p>
          </div>
      ...
      <section id="why-choose-us" className="py-12 md:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-base md:text-xl text-gray-600 max-w-3xl mx-auto">Create believable dwarf names with pattern-driven variants and privacy-first local generation.</p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-sm hover:shadow-xl border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">Curated prefixes and suffixes produce names that fit classic dwarf sensibilities.</p>
            </div>
            <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-sm hover:shadow-xl border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">Adjust categories, lengths, and formatting to fit your project's lore and style.</p>
            </div>
            <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-sm hover:shadow-xl border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">Export lists for collaborators, designers, and game teams without leaving the browser.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-r from-purple-600 to-blue-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-white mb-6">Ready to name your clan?</h2>
          <p className="text-xl text-purple-100 mb-8 max-w-2xl mx-auto">Generate authentic dwarf names for stories, campaigns, and assets — fast, private, and export-ready.</p>
